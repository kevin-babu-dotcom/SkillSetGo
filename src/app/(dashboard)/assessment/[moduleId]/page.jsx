...
export default function AssessmentPage({ params }) {
  const { currentIndex, responses, setAnswer, nextQuestion, prevQuestion } =
    useAssessmentStore();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto mt-8 flex gap-4">
          ...
          {isLastQuestion && (
            <button className="flex-1 px-4 py-3 bg-green-500 text-white rounded-lg font-medium hover:bg-green-600 transition-colors">
              Submit Assessment
            </button>
          )}
        </div>
